  ...
  return (
    <section
      className="
        ...
        pt-40 md:pt-32 xl:pt-20 bg-cover bg-center bg-no-repeat
      "
    ...
    >
      ...
      >
        <div className="w-full flex flex-col items-center xl:items-start text-center xl:text-left space-y-4 xl:space-y-[30px] order-1 xl:order-1 xl:mb-20">
          ...
          <div className="flex flex-col sm:flex-row gap-3 xl:gap-4 w-full justify-center max-w-sm mx-auto sm:max-w-none">
            <a
              href="#contact"
          ...
          <div className="flex flex-row justify-center xl:justify-start gap-2 xl:gap-4 w-full px-2 xl:px-0 max-w-sm mx-auto sm:max-w-none">
            {[
              ...
              <React.Fragment key={label}>
                {/* Mobile version */}
                <div
                  className="relative rounded-[14px] px-2 py-2.5 flex flex-col items-center gap-1 xl:hidden select-none w-full sm:flex-1"
                  style={{
                ...
                >
                  <div className="flex items-center gap-1">
                    ...
                    <p className="font-bold text-base text-[var(--text-orange-3,#ED6D0B)] whitespace-nowrap">
                ...
                {/* PC version */}
                <div
                  className="relative rounded-[14px] h-[75.5px] px-2 xl:px-3 py-2.5 hidden xl:flex items-center gap-[8px] xl:gap-[10px] select-none w-full sm:flex-1"
                  style={{
                    background: "rgba(42,42,42,0.40)",
                    backdropFilter: "blur(14px) saturate(140%)",
                    WebkitBackdropFilter: "blur(14px) saturate(140%)",
...
function Hero() {
  return (
    <section
      className="
        relative overflow-hidden from-gray-900 via-amber-900/20 to-gray-900
        pt-28 md:pt-32 xl:pt-20 bg-cover bg-center bg-no-repeat
      "
      style={{ backgroundImage: "url('/back1.png')" }}
    >
      <div
      ...
      >
        <div className="w-full flex flex-col items-center xl:items-start text-center xl:text-left space-y-4 xl:space-y-[30px] order-1 xl:order-1 xl:mb-20">
          ...
          <div className="flex flex-col gap-3 xl:gap-4 w-full justify-center max-w-sm mx-auto">
            <a
              href="#contact"
              className="inline-flex items-center justify-center h-10 px-3 rounded-lg text-[14px] xl:text-[14px] font-medium text-white gap-1 w-full whitespace-nowrap
                          transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95"
              style={{
                background: "var(--btn-base-orange, #FF7A1A)",
                boxShadow: [
            ...
            <a
              href="#features"
              className="inline-flex items-center justify-center h-12 xl:h-10 px-4 xl:px-4 rounded-lg text-[14px] xl:text-[14px] gap-[6px] font-medium text-white w-full whitespace-nowrap
                          transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95"
              style={{
                background: "var(--btn-base-grey, #232323)",
                boxShadow: [
          ...
          <div className="flex flex-row justify-center xl:justify-start gap-2 xl:gap-4 w-full px-2 xl:px-0 max-w-sm mx-auto">
            {[
              { icon: Star, value: 50000, label: "Utilisateurs actifs", suffix: "+" },
              { icon: Globe, value: 500, label: "Entreprises", suffix: "+" },
              { icon: TrendingUp, value: 54, label: "Pays africains" },
              ...
              <div
                key={label}
                className="relative rounded-[14px] px-2 xl:px-3 py-2.5 flex flex-col items-center gap-1 xl:flex-row xl:items-center xl:gap-[10px] select-none w-full sm:flex-1"
                style={{
                  background: "rgba(42,42,42,0.40)",
                  backdropFilter: "blur(14px) saturate(140%)",
                  WebkitBackdropFilter: "blur(14px) saturate(140%)",
